...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: "cadastro_pessoa_fisica_mfe", // This application named 'cadastro_pessoa_fisica_mfe'
      filename: "remoteEntry.js", // output a js file
      exposes: {
        // which exposes
        "./CadPessoaFisicaScreen": "./src/App", // a module 'CadPessoaFisicaScreen' from './src/App'
      },
      shared: {
        // and shared
